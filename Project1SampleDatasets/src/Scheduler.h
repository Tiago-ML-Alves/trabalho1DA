...
/**
 * @class Scheduler
 * @brief Orchestrates Max-Flow execution and interprets the results.
 *
 * On construction: resets flows → runs Edmonds–Karp → extracts assignments.
 * Call runRiskAnalysis(k) afterward to identify critical reviewers.
 */
